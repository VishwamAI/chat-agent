...
def apply_rotary_pos_emb(x, sincos):
    ...
    # Ensure cos and sin are broadcasted to match the shape of x1 and x2
    cos = jnp.broadcast_to(cos.reshape(1, cos.shape[0], 1, cos.shape[1]), (x1.shape[0], x1.shape[1], x1.shape[2], cos.shape[1]))
    sin = jnp.broadcast_to(sin.reshape(1, sin.shape[0], 1, sin.shape[1]), (x1.shape[0], x1.shape[1], x1.shape[2], sin.shape[1]))
