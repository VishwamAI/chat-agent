...
def apply_rotary_pos_emb(x, sincos):
    ...
    sin = sin.reshape(1, seq_len, head_dim).repeat(batch_size, axis=0).repeat(num_heads, axis=1)
    cos = cos.reshape(1, seq_len, head_dim).repeat(batch_size, axis=0).repeat(num_heads, axis=1)
