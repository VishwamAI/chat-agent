...
# Define the function to export the UNet model to ONNX format
def export_unet_to_onnx():
    ...
    # Extract the UNet model component
    unet_model = glide_model
    ...
    onnx_output_path = 'unet_model.onnx'
    torch.onnx.export(unet_model, (dummy_input, timesteps, tokens, mask), onnx_output_path, opset_version=12)

    print(f"UNet model has been successfully exported to {onnx_output_path}")
