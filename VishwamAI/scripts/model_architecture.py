...
class VishwamAIModel(hk.Module):
    ...
    def __call__(self, inputs):
        ...
        for i, expert in enumerate(self.experts):
            ...
            if jnp.any(mask):
                mask = jnp.expand_dims(mask, axis=2)  # Add necessary dimension to the mask
                ...
                expert_inputs = jnp.broadcast_to(expert_inputs, (embedded_inputs.shape[0], embedded_inputs.shape[1]))  # Ensure expert_inputs match inputs shape
